...
If you **follow the path of one team you're interested in**, you can see their whole record throughout the phase. Ghost seems to have continuously improved, while Wildcard went from average to below average. eUnited started strong and regressed to the mean, and Simplicity did the opposite.
...
The overall results are grouped in four distinct clusters, and are very close overall, especially at the top. Were the results much closer this phase than last? What did the points spread look like last phase in comparison? **Next week, I’ll be looking into parity**, which is a bit more complicated to analyze for this game than I first thought.

I've had a great time sharing my work with all of you over the past two months. Thanks for all the support.

The data I recorded and used is [here](https://pubgdataviz.netlify.com/post/Public_Data), and my .Rmd file is [here](https://github.com/vecoris/PUBG_Dataviz/blob/master/2019-06-13-phase-2-overview.Rmd), for those of you who are interested.


&#x200B;

**tl;dr Interactive tool to see how teams performed in Phase 2. Plus, Rumblers and Spacestation continued to outperform their luck by the highest margin of all teams, even though they both dropped off at the end.**